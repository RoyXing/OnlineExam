...
public class SharedPreferencesDB {
     ...
     * 配置数据库名称
     */
    private static final String CARNATION = "Exam";
    ...
    public synchronized static SharedPreferencesDB getInstance() {
        if (instance == null) {
            instance = new SharedPreferencesDB(MyApplication.getInstance());
        }
        return instance;
    }
